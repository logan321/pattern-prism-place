      ...
      <div className="w-80 border-r border-white/10 flex flex-col shrink-0 bg-[#0f0f0f]">
        <div className="p-4 border-b border-white/10 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-bold text-lg">Zonas Matriz UV</h2>
          </div>
          <Box className="w-5 h-5 text-orange-500" />
        </div>

        <div className="p-4 bg-orange-600/10 border-b border-orange-500/20">
          <p className="text-[10px] text-orange-400 font-bold uppercase tracking-wider leading-tight">
            Informação: As zonas agora são aplicadas automaticamente via matriz UV. Use este editor apenas para visualização ou ajustes finos.
          </p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2">
          {zones.length === 0 ? (
            <div className="text-center py-10 text-gray-500">
              ...
              <p className="text-sm">Nenhuma zona de matriz UV encontrada.</p>
            </div>
          ) : (
            zones.map(zone => (
              <div
